...
export type WorkflowCommission = {
  ...
  agentShareRate: string; calculatedAmount: string; confirmed: boolean; confirmedAt?: string | null;
};
...
export const confirmWorkflowCommission = (id: string) => apiFetch<{ data: WorkflowCommission }>(`/api/workflow/commissions/${id}/confirm`, { method: "PATCH" }).then(data);
