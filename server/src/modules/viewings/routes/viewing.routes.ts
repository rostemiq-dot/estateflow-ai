...
export const createViewingRouter = (
  service: ViewingServiceContract,
  ...
  router.post(
    "/",
    all,
    validateRequest("body", createViewingSchema),
    controller.create,
  );
  router.get(
    "/",
    validateRequest("query", listViewingsQuerySchema),
    controller.list,
  );
  router.get(
    "/calendar",
  ...
  router.get(
    "/:viewingId",
    validateRequest("params", viewingParamsSchema),
    controller.get,
  );
  router.patch(
    "/:viewingId",
    all,
    validateRequest("params", viewingParamsSchema),
    validateRequest("body", updateViewingSchema),
    controller.update,
  );
  router.delete(
    "/:viewingId",
