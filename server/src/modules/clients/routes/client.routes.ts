...
export const createClientRouter = (
  ...
  router.post(
    ...
    allRoles,
    validateRequest("params", clientIdParamsSchema),
    validateRequest("body", addClientRoleSchema),
    controller.addRole,
  );
  router.delete(
    "/:clientId/roles/:role",
    allRoles,
    validateRequest("params", clientChildParamsSchema),
  ...
  router.post(
    ...
    allRoles,
    validateRequest("params", clientIdParamsSchema),
    validateRequest("body", createPreferenceSchema),
    controller.createPreference,
  );
  router.patch(
    "/:clientId/preferences/:preferenceId",
    allRoles,
    validateRequest("params", clientChildParamsSchema),
    validateRequest("body", updatePreferenceSchema),
...
export const createClientTagRouter = (
  ...
  router.post(
    "/",
    managers,
    validateRequest("body", createClientTagSchema),
    controller.create,
  );
  router.patch(
    "/:tagId",
    managers,
    validateRequest("params", tagIdParamsSchema),
    validateRequest("body", updateClientTagSchema),
    controller.update,
  );
  router.delete(
    "/:tagId",
...
export const clientTagRouter = createClientTagRouter(
  new ClientTagService(repository),
  authenticate,
);
